...
export interface FluxContext {
   ...
   * Full types are available from `.flux/types.d.ts` (generated by `flux generate`).
   * In TypeScript projects: import type { FluxContext } from '.flux/types.js'
   */
  db: Record<string, {
