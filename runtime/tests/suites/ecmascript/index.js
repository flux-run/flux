...
export function createECMAScriptSuite() {
    ...
    suite.test("Symbol basics", () => {
        ...
        assert(sym1 !== sym2, "Symbols should be unique");
    });
    ...
    suite.test("type coercion", () => {
        assertEquals("5" + 5, 10, "String to number coercion should work");
        assertEquals(true + 1, 2, "Boolean to number coercion should work");
    });
    // Object methods
