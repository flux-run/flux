...
export const metadata: Metadata = {
  title: 'Architecture — Fluxbase Docs',
  description: 'How Fluxbase works: gateway, runtime, data engine, queue, and observability — the complete backend flow stack.',
}
...
<p class="page-subtitle">How Fluxbase works: five layers that turn a TypeScript function into a fully observable, production-ready API endpoint.</p>

<h2>Overview</h2>
<p>Every request to a Fluxbase project travels through a fixed set of layers. Each layer has a single responsibility, and every layer emits structured telemetry. The result is complete observability with zero configuration from your side.</p>
...
<h2>Service URLs</h2>
<p>All services are internal to the Fluxbase platform. From your function, you interact through <code>ctx</code>. The CLI talks to the public-facing API. You never configure service URLs.</p>
