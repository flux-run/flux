...
<div style="padding:56px 0;border-bottom:1px solid var(--border);">
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:48px;align-items:start;">
    <div><p style="color:var(--muted);line-height:1.8;margin-bottom:16px;"><code>flux tail</code> streams every request hitting your Fluxbase functions in real time. Successes appear in green. Failures appear in red with an inline error summary.</p>
