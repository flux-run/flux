...
<div id="trace-graph" style="padding:56px 0;border-bottom:1px solid var(--border);">
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:48px;align-items:start;">
    <div>
      ...
      <p style="color:var(--muted);line-height:1.8;margin-bottom:16px;">The gateway, runtime, data engine, tool calls, async jobs — every layer in Fluxbase emits spans without any instrumentation from you. Those spans are assembled into a <strong style="color:var(--text);">trace graph</strong> keyed by <code>request_id</code>.</p>
...
<div id="replay-engine" style="padding:56px 0;border-bottom:1px solid var(--border);">
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:48px;align-items:start;">
    <div>
      ...
      <p style="color:var(--muted);line-height:1.8;margin-bottom:16px;">Because every execution is recorded — inputs, state, secrets, timing — Fluxbase can re-run a production time window against your current code with side-effects disabled. Emails won't send. Payments won't process. Slack won't fire.</p>
