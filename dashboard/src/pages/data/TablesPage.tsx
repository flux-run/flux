...
export default function TablesPage() {
  const { projectId, database } = useParams<{ projectId: string; database: string }>()
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      ...
      <div className="flex items-center gap-1.5 text-xs text-muted-foreground mb-6">
        <Link to={`/dashboard/projects/${projectId}/data`} className="flex items-center gap-1 hover:text-foreground transition-colors">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <Button variant="ghost" size="icon" className="w-7 h-7" onClick={() => navigate(`/dashboard/projects/${projectId}/data`)}>
          ...
          {tables.map((t) => {
            ...
            return (
              <div
                ...
                onClick={() => navigate(`/dashboard/projects/${projectId}/data/${database}/${t.name}`)}
              >
