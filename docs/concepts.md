...
During execution, `flux-runtime` records **checkpoint spans** at IO boundaries — for example buffered outbound HTTP calls and deterministic TCP exchanges capture the request, response, and duration.
