...
pub async fn create_api_key(
    ...
    let record: Result<ApiKey, sqlx::Error> = sqlx::query_as!(
        ApiKey,
        r#"
...
pub async fn list_api_keys(
    ...
    let records: Result<Vec<ApiKey>, sqlx::Error> = sqlx::query_as!(
        ApiKey,
        r#"
...
pub async fn mark_key_used(
    ...
    let record: Result<Option<ApiKey>, sqlx::Error> = sqlx::query_as!(
        ApiKey,
        r#"
        UPDATE api_keys
